...
class ComicHelper:
    ...
    def get_random_hashtags(count: int = 3) -> List[str]:
        ...
        hashtag_pool = [
            "CalvinAndHobbes", "Comics", "Nostalgia", "BillWatterson",
            "Comics", "CalvinHobbes", "NewspaperComics", "ComicStrip",
            "Childhood", "ClassicComics", "Tiger", "Imagination",
            "Adventure", "Philosophy", "Wisdom", "Creativity"
        ]
